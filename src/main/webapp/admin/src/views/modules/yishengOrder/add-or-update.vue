    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="预约等级" prop="yishengOrderTypes">
                        <el-select v-model="ruleForm.yishengOrderTypes" :disabled="ro.yishengOrderTypes" placeholder="请选择预约等级">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="预约等级" prop="yishengOrderValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约详情" prop="yishengOrderText">
                        <el-input type="textarea"  :readonly="ro.yishengOrderText" v-model="ruleForm.yishengOrderText" placeholder="预约详情"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yishengOrderText" label="预约详情" prop="yishengOrderText">
                            <span v-html="ruleForm.yishengOrderText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
